 ...
 <body>
     <table class="border-bottom-header">
         <tr>
             ...
             <td width="85%">
                 <span class="text-center d-block font-11">
                     KEMENTERIAN PENDIDIKAN, KEBUDAYAAN, RISET, DAN TEKNOLOGI
                 </span>
                 <span class="text-center d-block font-13">
     ...
     <table class="border-all">
         ...
         <tbody>
             ...
             <tr>
                 ...
                 <td>{{ $s->barang ? $s->barang->barang_kode : '-' }}</td>
