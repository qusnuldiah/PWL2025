                 ...
                 <div class="modal-body">
                     ...
                     <table class="table table-sm table-bordered table-striped">
                         <tr>
                             ...
                             <td class="col-9">{{ $stok->barang ? $stok->barang->barang_kode : 'Tidak ditemukan' }}</td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                             ...
                             <td class="col-9">{{ $stok->stok_jumlah ?? '0' }}</td>
                         </tr>
                         <tr>
                     ...
                     $.ajax({
                         ...
                         success: function(response) {
                             if (response.status) {
                                 ...
                                 dataStok.ajax.reload(); // Ubah dataUser menjadi dataStok sesuai dengan DataTable stok
                             } else {
                                 $('.error-text').text('');
