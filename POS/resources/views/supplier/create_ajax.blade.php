        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_telpon" id="supplier_telpon" class="form-control" required>
                    <small id="error-supplier_telpon" class="error-text form-text text-danger"></small>
                </div>
            </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status) {
                            ...
                            dataSupplier.ajax.reload(); // disesuaikan dengan variabel datatable supplier
                        } else {
                            $('.error-text').text('');
