        ...
        <div class="card-body">
            <form method="POST" action="{{ url('kategori') }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    <label for="kategori_kode" class="col-1 control-label col-form-label">Kode Kategori</label>
                    <div class="col-11">
                ...
                <div class="form-group row">
                    <label for="kategori_nama" class="col-1 control-label col-form-label">Nama Kategori</label>
                    <div class="col-11">
